"""
Joint sigma_enc information-control and classifier-free-guidance sweep for SRUL.
...
For each requested tangent-noise value, this script:
  ...
  3. trains a separate class-conditional RFM prior on the corresponding noisy
     latent distribution;
  4. evaluates each trained prior at several classifier-free-guidance scales,
     reporting FID/KID/precision/recall with the same architecture and EMA.
...
The same script supports CIFAR-10, PathMNIST, and CelebA-64.
"""
