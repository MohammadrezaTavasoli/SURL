"""
Class-conditional SRUL-v2 on CIFAR-10, PathMNIST, or BloodMNIST with spatial product-of-spheres latents.
...
1. Class conditioning: v_theta(z_t, t, y) models each dataset class with the
...
Supported real datasets:
    ...
    cifar10   : 10 natural-image classes, 32x32 RGB
    pathmnist : 9 colon-histopathology tissue classes from MedMNIST.
    bloodmnist: 8 peripheral-blood-cell classes from MedMNIST.
                28x28 RGB images are resized to 32x32 for the same architecture
...
---------------------------
For CIFAR-10, reuse the already trained spatial autoencoder:
