...
- `srul_sigma_knob_sweep.py`: separate prior training for each information-control value.
...
- `cifar10_sigma_sweep.csv`: information-control ablation.
...
- `ablations.png`: information-control and classifier-free-guidance plots.
...
- `MATHEMATICAL_DETAILS.md`: derivations and intuitive explanations for the key losses, paths, sampling rule, and CFG.
...
- `report/SRUL_Final_Report_v26.pdf`
- `report/SRUL_Final_Report_v26.tex`
- `slides/SRUL_Final_5_Slides_v26.pptx`
- `slides/SRUL_Final_5_Slides_v26.pdf`
- `slides/SRUL_5min_Speaker_Script_v26.md`

- `docs/UPDATE_NOTES_v26.md`
