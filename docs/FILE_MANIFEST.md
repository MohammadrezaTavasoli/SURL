...
- `report/SRUL_Final_Report_v13.pdf`: final report.
- `slides/SRUL_Final_5_Slides_v13.pdf`: final five-slide presentation.
- `slides/SRUL_5min_Speaker_Script_v13.md`: presentation script.
