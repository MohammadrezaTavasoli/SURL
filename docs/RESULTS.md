...
CIFAR-10 is used for controlled geometry, support-matching, noise, and guidance studies. PathMNIST tests histopathology texture. CelebA-64 tests the larger `64x64` setting with an `8x8` token grid.
