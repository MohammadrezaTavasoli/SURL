...
The experiment keeps the same trained VAE encoder and decoder and changes only the prior.
...
Full metrics, including KID, are stored in the repository CSV files but are omitted from the main comparison table for clarity.
